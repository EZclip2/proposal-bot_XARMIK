...
// webapp.html лежит в корне репозитория рядом с bot.js
...
async function createSuggestion(msg) {
  ...
  const rec = {
    id: store.nextId(), userId: from.id, userMention: mention,
    isMedia: !isText, bodyText: msg.text || msg.caption || '',
    state: 'new', moderatorId: null, moderatorName: null,
    answerText: null, modMessageId: null, createdAt: Date.now(),
  };
